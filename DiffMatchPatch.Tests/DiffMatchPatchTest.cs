...
namespace DiffMatchPatch.Tests
{
    public class diff_match_patchTest : diff_match_patch
    {
        ...
        public void diff_charsToLinesTest()
        {
            ...
            this.diff_charsToLines(diffs, tmpVector);
            assertEquals("diff_charsToLines: More than 256.", new List<Diff> { new Diff(Operation.DELETE, lines) }, diffs);
        ...
        public void diff_bisectTest()
        {
            ...
            // Timeout.
            diffs = new List<Diff> {
                new Diff(Operation.DELETE, "cat"), 
                new Diff(Operation.INSERT, "map")
            };
